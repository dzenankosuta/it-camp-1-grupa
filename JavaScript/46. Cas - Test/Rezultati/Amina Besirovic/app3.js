...
const newArray2 = CART_DATA.map((el) => {
  return { name: el.name, total: el.price * el.amount };
});
...
console.log(
  `You got ${newArray2} in cart,shipping cost is ${shippingCosts}, your total is ${suma}`
);
